    ...
    return(
        <div className="pl-4">
            <form method="POST" onSubmit={handleSubmit}>
                <input className="w-full mt-4 pl-2 h-12 mb-2  rounded-sm border border-indigo-800" type="text" id="comment" name="comment" value={comment} onChange={(e)=>setComment(e.target.value)} placeholder="Create Comment" required/>
