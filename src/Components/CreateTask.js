...
const CreateTask = (props) =>{
    ...
    function handleSubmit(e){
        ...
        if(formState.assigneeId){
            axios.post(`http://localhost:3000/users/${userId}/tasks`, { task: {title: formState.title, body: formState.body, assignee_id: formState.assigneeId, creator_id: userId, due_date: formState.due_date, recurring_code: formState.recurring_code}},
